...
import { BarChart3, GraduationCap, TrendingUp, Award, FolderOpen, Settings, User, LogOut } from 'lucide-react';
        ...
        <div className="bg-sidebar-accent rounded-2xl p-4 transition-all duration-300 hover:bg-sidebar-accent/80">
          ...
          <div className="flex gap-2">
            {(open || isMobile) ? (
              ...
              <button className="w-full flex items-center justify-center py-2 rounded-xl bg-sidebar-border/50 hover:bg-red-500/10 hover:text-red-400 transition-colors text-sidebar-foreground/70">
